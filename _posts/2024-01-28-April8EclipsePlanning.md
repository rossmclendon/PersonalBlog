...
If you don't have access to solar filters, there are any number of [techniques](https://eclipse.aas.org/eye-safety/projection) to *indirectly* view the partially eclipsed sun.  Again, don't bother with these during totality - just look at the corona directly at during that phase.
...
# Photography
I'm planning to add a post on my [photography website blog](https://rossmclendonphotography.com/blog/) about photographing a total eclipse in the coming days (I already have a post there on the partial eclipse I photographed back in 2020).  If this is your *first* time to see a total eclipse, consider whether it's worth spending time during those precious 3-4 minutes of totality futzing with a camera.  My suggestion would be that unless you're really passionate about the photography thing, it's best to just enjoy the moment.  Total eclipses are very dynamic events, require somewhat specialized equipment to photograph well, and if you make it about photography you stand to miss out on (or dilute) what should be an incredible experience.  That said, I didn't follow this sound advice in 2017 and in retrospect I'm happy with that choice, but I'm also a huge photography nerd who enjoys highly technical challenges.  I think for most people, leaving the camera in the bag or just pulling it out a few seconds to shoot a couple of shots on some auto mode is pretty good advice.
...
It *just so happens* that these distances mean that sometimes, the moon (which is much smaller but much closer) is very similar in its apparent size in the sky compared to the sun - sometimes slightly larger, and sometimes slightly smaller.  This means that when the moon happens to pass in front of the sun on an occasion when it's slightly larger in apparent size, it casts a shadow that *just barely* reaches all the way to the earth, casting a shadow about 100 miles in diameter on the surface of the earth.

Then, there's the orbit.  The moon's orbital plane is a bit skewed from the sun's orbital plane.  This means that we don't get an eclipse every month, but instead only a couple of times a year when the orbits line up.  This also means that eclipse paths tend to be scattered all over the earth - any given location on the earth will experience a total eclipse on average once every ~375 years.
